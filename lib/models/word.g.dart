...
void _wordSerialize(
  ...
  writer.writeBool(offsets[1], object.isLearner);
  writer.writeString(offsets[2], object.story);
  writer.writeString(offsets[3], object.turkishWord);
  writer.writeString(offsets[4], object.wordType);
}
...
Word _wordDeserialize(
  ...
  final object = Word(
    ...
    story: reader.readStringOrNull(offsets[2]),
    turkishWord: reader.readString(offsets[3]),
    wordType: reader.readString(offsets[4]),
  );
  object.id = id;
  object.isLearner = reader.readBool(offsets[1]);
  return object;
}
...
extension WordQueryFilter on QueryBuilder<Word, Word, QFilterCondition> {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> isLearnerEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isLearner',
        value: value,
      ));
    });
  }
...
extension WordQuerySortBy on QueryBuilder<Word, Word, QSortBy> {
  ...
  QueryBuilder<Word, Word, QAfterSortBy> sortByIsLearner() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLearner', Sort.asc);
    });
  }

  QueryBuilder<Word, Word, QAfterSortBy> sortByIsLearnerDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLearner', Sort.desc);
    });
  }
...
extension WordQuerySortThenBy on QueryBuilder<Word, Word, QSortThenBy> {
  ...
  QueryBuilder<Word, Word, QAfterSortBy> thenByIsLearner() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLearner', Sort.asc);
    });
  }

  QueryBuilder<Word, Word, QAfterSortBy> thenByIsLearnerDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLearner', Sort.desc);
    });
  }
...
extension WordQueryWhereDistinct on QueryBuilder<Word, Word, QDistinct> {
  ...
  QueryBuilder<Word, Word, QDistinct> distinctByIsLearner() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isLearner');
    });
  }
...
extension WordQueryProperty on QueryBuilder<Word, Word, QQueryProperty> {
  ...
  QueryBuilder<Word, bool, QQueryOperations> isLearnerProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isLearner');
    });
  }
